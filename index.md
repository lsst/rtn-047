...
Designate Rubin Observatory data in the Euclid Deep Field South (EDF-S) as fully world-public on an ongoing basis, thereby establishing EDF-S as a standing legacy field in the model of COSMOS, and providing the Rubin data required to produce an open, validated, AI-ready dataset spanning the three major large sky surveys of the coming decade, to enable joint survey processing.
...
A 2022 white paper ({cite}`Guy2022`) defined an initial set of Rubin-Euclid Derived Data Products (DDPs) specifically to realize the far greater science return of the two surveys combined. This vision has an obvious near-term extension to NASA's Roman Space Telescope. 
...
This proposal therefore recommends that Rubin's EDF-S data be designated fully world-public, giving the community access to data from all three key surveys over one common field. 
...
It gives Rubin a field where it can openly showcase its groundbreaking and unique science to the broadest possible audience, a strong win for public and community engagement. 
